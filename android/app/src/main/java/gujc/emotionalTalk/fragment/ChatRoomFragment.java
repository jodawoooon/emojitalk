...
import gujc.emotionalTalk.model.ChatRoomModel;
...
//                    a.orderBy("timestamp", Query.Direction.DESCENDING)
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (chatRoomModel.getPhoto()==null) {
                ...
                roomViewHolder.room_image.setImageDrawable(getResources().getDrawable(R.drawable.user));
            ...
            roomViewHolder.itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), FaceDetectionActivity.class);
