...
import gujc.emotionalTalk.chat.FaceDetectionActivity;
import gujc.emotionalTalk.common.FirestoreAdapter;
    ...
    class RecyclerViewAdapter extends FirestoreAdapter<CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder viewHolder, int position) {
            ...
            if (user.getUserphoto()==null) {
                ...
                viewHolder.user_photo.setImageDrawable(getResources().getDrawable(R.drawable.user));
            } else{
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getView().getContext(), FaceDetectionActivity.class);
                    intent.putExtra("toUid", user.getUid());
                    intent.putExtra("toUsernm",user.getUsernm());
